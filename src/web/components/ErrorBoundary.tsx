	...
	return (
		<div className="flex flex-col items-center justify-center min-h-96 p-8 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
			<div className="text-center max-w-md">
				...
				<h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t('error.title')}</h3>
				<p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
					{t('error.description')}
				</p>
				{error && process.env.NODE_ENV === 'development' && (
					<details className="mt-4 text-left">
						<summary className="text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">{t('error.technicalDetails')}</summary>
